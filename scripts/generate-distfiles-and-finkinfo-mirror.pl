...
BEGIN {
	# home
	#our $CHECKOUTDIR = '/tmp/finkinfo';
	#our $DOWNLOADDIR = '/tmp/distfiles';
	#our $FINKROOT    = '/Users/ranger/cvs/fink';
	#our $SVNROOT     = '/sw/fink/dists/local/rangerrick';

	# finch
	our $CHECKOUTDIR = '/var/www/finkinfo';
	our $DOWNLOADDIR = '/var/www/distfiles';
	our $FINKROOT    = '/home/ranger/cvs/fink';
...
$COUNT = 0;
$CVSROOT=':ext:rangerrick@fink.cvs.sourceforge.net:/cvsroot/fink';
$DEBUG = 0;
$ENV{CVS_RSH} = $SVNROOT . '/scripts/ssh.sh';
