...
my $package_lookup = {
	'all' => {
		...
		'^dbus-dev$'                      => 'dbus1.3-dev',
		'^dbus-shlibs$'                   => 'dbus1.3-shlibs',
...
my $version_lookup = {
	'all' => {
		...
		'^kdebase4.*$'                        => [ '4.5.1',        '1'    ],
		'^kdeedu4.*$'                         => [ '4.5.1',        '1'    ],
		'^kdegraphics4.*$'                    => [ '4.5.1',        '1'    ],
		'^kdelibs4.*$'                        => [ '4.5.1',        '1'    ],
		'^kdemultimedia4.*$'                  => [ '4.5.1',        '1'    ],
		'^kdepim4.*$'                         => [ '4.5.1',        '1'    ],
		'^kdepimlibs4.*$'                     => [ '4.5.1',        '1'    ],
		'^kde.*3.*$'                          => [ '3.5.10',       '10'   ],
