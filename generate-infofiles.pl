...
my $version_lookup = {
	'all' => {
		...
		'^gst-plugins-bad-0.10.*$'            => [ '0.10.13',      '1'    ],
		'^gst-plugins-base-0.10.*$'           => [ '0.10.24',      '1'    ],
		'^gst-plugins-good-0.10.*$'           => [ '0.10.15',      '1'    ],
		'^gst-plugins-ugly-0.10.*$'           => [ '0.10.12',      '1'    ],
		'^gst-python-0.10.*$'                 => [ '0.10.16',      '1'    ],
		'^gstreamer-0.10.*$'                  => [ '0.10.24',      '1'    ],
		...
		'^kdebase4.*$'                        => [ '4.3.2',        '1'    ],
		'^kdeedu4.*$'                         => [ '4.3.2',        '1'    ],
		'^kdegraphics4.*$'                    => [ '4.3.2',        '1'    ],
		'^kdelibs4.*$'                        => [ '4.3.2',        '1'    ],
		'^kdemultimedia4.*$'                  => [ '4.3.2',        '1'    ],
		'^kdepim4.*$'                         => [ '4.3.2',        '1'    ],
		'^kdepimlibs4.*$'                     => [ '4.3.2',        '1'    ],
